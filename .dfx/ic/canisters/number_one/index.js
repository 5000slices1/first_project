...
import { idlFactory } from './number_one.did.js';
export { idlFactory } from './number_one.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NUMBER_ONE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./number_one.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the number_one canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./number_one.did.js")._SERVICE>}
 */
export const number_one = createActor(canisterId);
